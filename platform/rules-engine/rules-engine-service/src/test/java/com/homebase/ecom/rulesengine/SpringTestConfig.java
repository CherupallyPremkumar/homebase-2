...
/**
 * Spring Boot test configuration for Rules Engine BDD tests.
 *
 * Excludes Chenile's security configuration to avoid requiring
 * a running Keycloak instance. Provides stub replacements.
 */
@Configuration
@PropertySource("classpath:com/homebase/ecom/rulesengine/TestService.properties")
@SpringBootApplication(scanBasePackages = {
    "org.chenile.configuration",
    "org.chenile.service.registry.configuration",
    "com.homebase.ecom.rulesengine.configuration",
    "com.homebase.ecom.rulesengine.infrastructure",
    "com.homebase.ecom.rulesengine.service"
})
@ComponentScan(
    basePackages = {
        "org.chenile.configuration",
