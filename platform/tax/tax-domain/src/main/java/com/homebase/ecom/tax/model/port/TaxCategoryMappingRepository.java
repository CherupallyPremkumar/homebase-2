...
public interface TaxCategoryMappingRepository {
    ...
    Optional<TaxCategoryMapping> findByCategory(String productCategory);
    Optional<TaxCategoryMapping> findByCategoryAndSubCategory(String productCategory, String subCategory);
