package com.homebase.ecom.compliance;
...
@Configuration
@PropertySource("classpath:com/homebase/ecom/compliance/TestService.properties")
@SpringBootApplication(scanBasePackages = {
    "org.chenile.**",
    "com.homebase.ecom.compliance.**"
})
@EnableJpaRepositories(basePackages = {
    "com.homebase.ecom.compliance.infrastructure.persistence.repository",
    "org.chenile.service.registry.configuration.dao"
})
@EntityScan(basePackages = {
    "com.homebase.ecom.compliance.infrastructure.persistence.entity",
