...
public class AgreementRetireAction extends AbstractSTMTransitionAction<Agreement, MinimalPayload> {

    private final ComplianceValidator validator;

    public AgreementRetireAction(ComplianceValidator validator) {
