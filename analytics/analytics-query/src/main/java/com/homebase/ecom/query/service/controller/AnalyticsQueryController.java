...
@RestController
@ChenileController(value = "analyticsQuery", serviceName = "searchService")
public class AnalyticsQueryController extends ControllerSupport {
    @PostMapping({ "/analytics/{queryName}" })
