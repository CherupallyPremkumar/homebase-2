...
/**
 * Post-save hook executed when fulfillment saga enters INITIATED state.
 */
public class INITIATEDFulfillmentPostSaveHook implements PostSaveHook<FulfillmentSaga> {
    @Override
