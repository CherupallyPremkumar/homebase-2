...
Scenario: Send the repairDamageds event to the inventory with comments
Given that "comment" equals "Comment for repairDamageds"
And that "event" equals "repairDamageds"
When I PATCH a REST request to URL "/inventory/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
