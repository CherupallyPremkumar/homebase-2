...
@RestController
@ChenileController(value = "catalogQuery", serviceName = "searchService")
public class CatalogQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/catalog/{queryName}" })
