...
@RestController
@ChenileController(value = "supplierQuery", serviceName = "searchService")
public class SupplierQueryController extends ControllerSupport {
    @PostMapping({ "/supplier/{queryName}" })
