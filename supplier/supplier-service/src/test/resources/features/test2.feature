...
Tests the supplier rejection flow using a REST client.
Supplier is created, reviewed, rejected with reason, then verified state.
...
"""json
{
    "businessName": "Test Supplier 2",
    "businessType": "INDIVIDUAL",
    "contactEmail": "test2@supplier.com"
}
"""
...
Given that "comment" equals "Incomplete documentation"
