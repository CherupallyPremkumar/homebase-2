...
@RestController
@ChenileController(value = "rulesEngineQuery", serviceName = "searchService")
public class RulesEngineQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/rules-engine/{queryName}" })
