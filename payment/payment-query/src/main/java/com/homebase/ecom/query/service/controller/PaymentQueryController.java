...
@RestController
@ChenileController(value = "paymentQuery", serviceName = "searchService")
public class PaymentQueryController extends ControllerSupport {
    @PostMapping({ "/payment/{queryName}" })
