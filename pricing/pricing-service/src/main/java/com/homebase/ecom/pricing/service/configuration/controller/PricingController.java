package com.homebase.ecom.pricing.service.configuration.controller;
...
@RestController
@ChenileController(value = "pricingService", serviceName = "_pricingService_")
public class PricingController extends ControllerSupport {
    ...
    @PostMapping("/pricing/_verify-price")
    public ResponseEntity<GenericResponse<Object>> verifyPrice(
            HttpServletRequest request,
            @RequestBody PriceVerificationRequestDTO body) {
        return process(request, body);
    }
}
