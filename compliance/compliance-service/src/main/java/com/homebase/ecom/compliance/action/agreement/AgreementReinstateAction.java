...
public class AgreementReinstateAction extends AbstractSTMTransitionAction<Agreement, MinimalPayload> {

    private final ComplianceValidator validator;

    public AgreementReinstateAction(ComplianceValidator validator) {
    ...
    public void transitionTo(Agreement entity, MinimalPayload payload,
        ...
        validator.validateCommentRequired(comment, "reinstate");
        entity.addActivity("reinstate", comment);
    }
}
