...
Please note that the code generated by this must be customized to take care of specific requirements.
    The JPA code persists to H2 database by default. Please change the configurations under build-configurations
    to customize this code. You may also want to edit build-package/pom.xml to reflect the correct DB
