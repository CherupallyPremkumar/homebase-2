...
@RestController
@ChenileController(value = "supportQuery", serviceName = "searchService")
public class SupportQueryController extends ControllerSupport {
    @PostMapping({ "/support/{queryName}" })
