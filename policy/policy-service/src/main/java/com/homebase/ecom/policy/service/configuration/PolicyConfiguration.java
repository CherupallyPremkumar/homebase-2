package com.homebase.ecom.policy.service.configuration;
...
import com.homebase.ecom.policy.service.postSaveHooks.*;
import com.homebase.ecom.policy.service.impl.*;
...
public class PolicyConfiguration {
    ...
    @Bean
    public PolicyService policyService(PolicyRepository repository, StateEntityServiceImpl<Policy> stateService, FactMetadataService factMetadataService) {
        return new PolicyServiceImpl(repository, stateService, factMetadataService);
    }
    
    @Bean
    public com.homebase.ecom.policy.service.loader.PolicyDataLoader policyDataLoader(
            PolicyRepository repository) {
        return new com.homebase.ecom.policy.service.loader.PolicyDataLoader(repository, new com.fasterxml.jackson.databind.ObjectMapper());
    }
}
