package com.homebase.ecom.demoorder.service.cmds;
...
/**
 * Default no-op transition action for demo order STM.
 * Used when no specific transition action is registered for an event.
 */
