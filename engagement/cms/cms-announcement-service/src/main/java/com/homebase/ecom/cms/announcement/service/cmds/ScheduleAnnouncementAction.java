...
/**
 * Handles the schedule transition (DRAFT -> SCHEDULED).
 * Sets status to SCHEDULED.
 */
public class ScheduleAnnouncementAction extends AbstractSTMTransitionAction<Announcement, Announcement> {

    private static final Logger log = LoggerFactory.getLogger(ScheduleAnnouncementAction.class);
    ...
    public void transitionTo(Announcement announcement, Announcement payload,
        ...
        log.info("Announcement '{}' scheduled, transitioning from {} to {}",
