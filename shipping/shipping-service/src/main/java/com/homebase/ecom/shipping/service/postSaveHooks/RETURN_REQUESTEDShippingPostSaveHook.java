...
/**
 * PostSaveHook for RETURN_REQUESTED state.
 * Publishes ReturnShipmentCreatedEvent after return request is persisted.
 */
public class RETURN_REQUESTEDShippingPostSaveHook implements PostSaveHook<Shipping> {
    ...
    public void execute(State startState, State endState, Shipping shipping, TransientMap map) {
        eventPublisher.publishReturnShipmentCreated(shipping);
    }
}
