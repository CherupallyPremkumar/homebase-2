...
@RestController
@ChenileController(value = "shippingQuery", serviceName = "searchService")
public class ShippingQueryController extends ControllerSupport {
    @PostMapping({ "/shipping/{queryName}" })
