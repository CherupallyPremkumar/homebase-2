...
/**
 * ACTIVE / KYC_PENDING / KYC_VERIFIED -> SUSPENDED.
 *
 * Admin-initiated suspension. Requires a reason (fraud, policy violation, etc.).
 * The reason is stored on the user for audit and displayed on login attempts.
 */
public class SuspendAction implements STMTransitionAction<User> {
    @Override
