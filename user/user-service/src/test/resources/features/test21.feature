...
Scenario: Send the deactivateSupplier event to the user with comments
Given that "comment" equals "Comment for deactivateSupplier"
And that "event" equals "deactivateSupplier"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
...
Scenario: Send the reactivateAccount event to the user with comments
Given that "comment" equals "Comment for reactivateAccount"
And that "event" equals "reactivateAccount"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
...
Scenario: Send the suspendAccount event to the user with comments
Given that "comment" equals "Comment for suspendAccount"
And that "event" equals "suspendAccount"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
