...
Scenario: Send the unsuspendAccount event to the user with comments
Given that "comment" equals "Comment for unsuspendAccount"
And that "event" equals "unsuspendAccount"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
...
Scenario: Send the deactivateAccount event to the user with comments
Given that "comment" equals "Comment for deactivateAccount"
And that "event" equals "deactivateAccount"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
...
Scenario: Send the deleteAccount event to the user with comments
