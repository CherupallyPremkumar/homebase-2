...
Scenario: Send the activateAccount event to the user with comments
Given that "comment" equals "Comment for activateAccount"
And that "event" equals "activateAccount"
When I PATCH a REST request to URL "/user/${id}/${event}" with payload
"""json
{
    "comment": "${comment}"
