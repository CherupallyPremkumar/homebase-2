...
import com.homebase.ecom.user.dto.CompleteProfileUserPayload;
...
*/
public class CompleteProfileUserAction extends AbstractSTMTransitionAction<User,
	...
	public void transitionTo(User user,
            CompleteProfileUserPayload payload,
