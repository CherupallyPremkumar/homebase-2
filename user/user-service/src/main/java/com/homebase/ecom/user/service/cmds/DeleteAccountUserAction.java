...
import com.homebase.ecom.user.dto.DeleteAccountUserPayload;
...
*/
public class DeleteAccountUserAction extends AbstractSTMTransitionAction<User,
	...
	public void transitionTo(User user,
            DeleteAccountUserPayload payload,
