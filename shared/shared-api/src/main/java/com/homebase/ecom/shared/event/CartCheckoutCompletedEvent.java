...
/**
 * Kafka event DTO published when a cart checkout is completed.
 */
public class CartCheckoutCompletedEvent implements Serializable {
    ...
    public CartCheckoutCompletedEvent() {
    }
