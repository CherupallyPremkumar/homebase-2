...
public class InventoryReservationFailedAction extends AbstractCartAction<MinimalPayload> {
    ...
    public void transitionTo(Cart cart, MinimalPayload payload, State startState, String eventId,
        ...
        logActivity(cart, "Reserve Failed", "Inventory reservation failed. Reverting to ACTIVE.");
    }
}
