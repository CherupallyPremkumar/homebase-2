...
public class Payment extends AbstractExtendedStateEntity
    ...
    // ── Payment Method ─────────────────────────────────────────────────────
    private String paymentMethod;       // CARD, UPI, NET_BANKING, WALLET, COD, EMI, BNPL
    private String paymentMethodType;   // CREDIT_CARD, DEBIT_CARD, UPI_COLLECT, UPI_INTENT, etc.

    // ── Masked Instrument (PCI safe) ───────────────────────────────────────
    private String maskedInstrument;    // "****1234" or "u***@upi"
    ...
    public boolean isFullRefund() {
        return refundAmount != null && amount != null
