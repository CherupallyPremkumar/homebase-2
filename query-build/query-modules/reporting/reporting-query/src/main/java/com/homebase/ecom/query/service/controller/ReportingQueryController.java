...
@RestController
@ChenileController(value = "reportingQuery", serviceName = "searchService")
public class ReportingQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/reporting/{queryName}" })
