...
@RestController
@ChenileController(value = "clickstreamQuery", serviceName = "searchService")
public class ClickstreamQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/clickstream/{queryName}" })
