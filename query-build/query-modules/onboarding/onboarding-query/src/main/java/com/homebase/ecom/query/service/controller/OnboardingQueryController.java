...
@RestController
@ChenileController(value = "onboardingQuery", serviceName = "searchService")
public class OnboardingQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/onboarding/{queryName}" })
