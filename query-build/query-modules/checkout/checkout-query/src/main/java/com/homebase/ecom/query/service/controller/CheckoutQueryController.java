...
@RestController
@ChenileController(value = "checkoutQuery", serviceName = "searchService")
public class CheckoutQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/checkout/{queryName}" })
