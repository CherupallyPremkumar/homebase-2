...
@RestController
@ChenileController(value = "pricingQuery", serviceName = "searchService")
public class PricingQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({"/pricing/{queryName}"})
