...
@RestController
@ChenileController(value = "returnRequestQuery", serviceName = "searchService")
public class ReturnRequestQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/returnrequest/{queryName}" })
