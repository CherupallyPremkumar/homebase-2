...
/**
 * WMS query controller -- cross-BC joined queries for Warehouse Management System.
 * Joins warehouse, inventory, fulfillment, products.
 */
@RestController
@ChenileController(value = "wmsQuery", serviceName = "searchService")
public class WmsQueryController extends ControllerSupport {

    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/wms/{queryName}" })
