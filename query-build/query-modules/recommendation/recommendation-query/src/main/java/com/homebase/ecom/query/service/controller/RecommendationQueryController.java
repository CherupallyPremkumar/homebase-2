...
@RestController
@ChenileController(value = "recommendationQuery", serviceName = "searchService")
public class RecommendationQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/recommendation/{queryName}" })
