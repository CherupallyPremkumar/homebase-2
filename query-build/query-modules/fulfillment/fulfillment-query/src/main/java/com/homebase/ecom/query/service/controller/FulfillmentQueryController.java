...
@RestController
@ChenileController(value = "fulfillmentQuery", serviceName = "searchService")
public class FulfillmentQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/fulfillment/{queryName}" })
