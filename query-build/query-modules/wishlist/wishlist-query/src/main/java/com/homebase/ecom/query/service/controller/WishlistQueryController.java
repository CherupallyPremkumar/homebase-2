...
@RestController
@ChenileController(value = "wishlistQuery", serviceName = "searchService")
public class WishlistQueryController extends ControllerSupport {
    @SecurityConfig(authoritiesSupplier = "queryAuthorities")
    @PostMapping({ "/wishlist/{queryName}" })
